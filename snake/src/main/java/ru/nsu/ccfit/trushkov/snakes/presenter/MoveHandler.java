...
import ru.nsu.ccfit.trushkov.snakes.config.Config;
import ru.nsu.ccfit.trushkov.snakes.game.GameObserver;
import ru.nsu.ccfit.trushkov.snakes.game.GameState;
import ru.nsu.ccfit.trushkov.snakes.game.cell.Point;
import ru.nsu.ccfit.trushkov.snakes.game.player.Player;
import ru.nsu.ccfit.trushkov.snakes.game.player.PlayerWithScore;
import ru.nsu.ccfit.trushkov.snakes.game.snake.SnakeInfo;
import ru.nsu.ccfit.trushkov.snakes.gui.controllers.View;
import ru.nsu.ccfit.trushkov.snakes.gui.utils.GameInfoWithButton;
import ru.nsu.ccfit.trushkov.snakes.gui.utils.PlayerColorMapper;
import ru.nsu.ccfit.trushkov.snakes.net.MainNodeHandler;
import ru.nsu.ccfit.trushkov.snakes.net.gamelistchecker.GameInfo;
import ru.nsu.ccfit.trushkov.snakes.net.gamelistchecker.GameListObserver;
import ru.nsu.ccfit.trushkov.snakes.net.node.Role;
import ru.nsu.ccfit.trushkov.snakes.presenter.event.JoinToGameEvent;
import ru.nsu.ccfit.trushkov.snakes.presenter.event.MoveEvent;
import ru.nsu.ccfit.trushkov.snakes.presenter.event.UserEvent;
import ru.nsu.ccfit.trushkov.snakes.presenter.event.UserEventType;
