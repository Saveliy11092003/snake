...
import ru.nsu.ccfit.trushkov.snakes.presenter.GamePresenter;
import ru.nsu.ccfit.trushkov.snakes.presenter.event.ExitEvent;
...
import ru.nsu.ccfit.trushkov.snakes.presenter.event.NewGameEvent;
...
public class GameViewController implements View {
    ...
    private static final Paint FRUIT_COLOR = Color.BLACK;
